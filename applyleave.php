	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 ">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="./alprocess.php?id=<?php echo $id?>" method="POST">
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--blu" type="submit">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
		...
		<table>
			...
			<?php
				...
				$sql = "SELECT empinfo.id, empinfo.fname, empinfo.lname, empleave.start, empleave.end, empleave.reason, empleave.status FROM empinfo, empleave WHERE empinfo.id = $id and empleave.id = $id ORDER BY empleave.token";
				$result = mysqli_query($conn, $sql);
